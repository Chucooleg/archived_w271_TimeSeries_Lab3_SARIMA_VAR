...
From the time plots and acf plots, the residual series is clearly time-dependent and still picks up most of the random walk behaviors in the unemployment rate. The acf and pacf plots still show evidence of a strong AR(1) process. Contradicting the cointegration test results, these residual plots don't fully support the existence of linear combination between the two series that is entirely stationary. A VAR model is probably more appropriate than cointegration specific models, like VECM.
